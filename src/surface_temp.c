...
void surface_temperature(double temp_air, double rh_air, double depth_snow, double depth_water,
    ...
    if (depth_snow <= 0.02) {
        ...
        *temp_ground = clamp(*temp_ground, temp_ground_last - 25, temp_ground_last + 25);
        ...
        *temp_soil0 = clamp(*temp_soil0, temp_air - 25, temp_air + 25);
        ...
        *temp_snow = clamp(*temp_snow, temp_air - 25, temp_air + 25);
        ...
        *temp_ground = clamp(*temp_ground, temp_air - 25, temp_air + 25);
